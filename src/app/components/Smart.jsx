    ...
    return (
        <>
            <div className='flex justify-center px-4'>
                ...
                <div className='w-full max-w-[1280px] h-auto md:h-[512px] relative rounded-3xl'>
                    ...
                    <div className="md:absolute w-full mt-10 md:mt-[266px] h-auto md:h-[512px] bg-gradient-to-b from-transparent rounded-3xl to-blue-400 backdrop-blur-[3px] pb-10 md:pb-0" >
                        ...
                        <div className='flex justify-center px-4'>
                            ...
                            <p className='text-[#414348] w-full max-w-[460px] text-center mt-[25px]'>
                        ...
                        <div className='flex justify-center px-4'>
                            ...
                            <div className="flex flex-col md:flex-row gap-4 mt-8 md:mt-[56px]">
                                {/* Get Started Now button */}
                                <button className="bg-blue-600 text-white px-6 py-2 rounded-full flex justify-center items-center gap-2 hover:bg-blue-700 transition duration-300">
                                    Get Started Now
